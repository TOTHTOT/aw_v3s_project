...
###
 ...
 # @LastEditTime: 2023-09-29 09:51:17
 # @LastEditors: TOTHTOT
 # @FilePath: /aw_v3s_project/01_ctrl_rgbled/build_project.sh
### 

INPUT_ARGS_NUM=$#
APP_SOURCE_C=$1
BUILD_NAME="rgbled_drive.ko"
BUILD_APP_NAME="rgbled_app"
MAKE_FILE_MODULES_NAME="rgbled_drive.o"
